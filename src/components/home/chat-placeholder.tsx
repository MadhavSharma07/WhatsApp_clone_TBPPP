	...
	return (
		<div className='w-3/4 bg-gray-secondary flex flex-col items-center justify-center py-10'>
			<div className='flex flex-col items-center w-full justify-center py-10 gap-4'>
				<Image src={"/desktop-hero.png"} alt='Hero' width={400} height={250} />
				...
				<Button onClick={handleButtonClick}  className='rounded-full my-5 bg-green-primary hover:bg-green-secondary'>
